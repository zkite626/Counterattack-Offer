...
function renderSectionTitle(title: string, icon: string, themeColor: string) {
  return (
    <h2 className="resume-section__heading resume-section__heading--modern" style={{ color: themeColor }}>
      <span
        className="resume-section__heading-bar"
...
export default function ModernTemplate({ data, template }: ModernTemplateProps) {
  ...
  return (
    <div
      className="resume-tpl resume-tpl--modern"
      style={{
