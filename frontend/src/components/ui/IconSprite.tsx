/**
 * IconSprite — 全局 SVG 图标精灵图
 * 基于 iconfont.cn 图标集，内联 SVG 符号定义
 * 渲染在 layout body 顶部，通过 <use> 引用
 */
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
      ...
      <symbol id="icon-user" viewBox="0 0 24 24">
        <path d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5zm0 2c-3.315 0-10 1.66-10 5v2h20v-2c0-3.34-6.685-5-10-5z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-diagnosis" viewBox="0 0 24 24">
      ...
      <symbol id="icon-match" viewBox="0 0 24 24">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-resume" viewBox="0 0 24 24">
        <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15.01V17h2v-1.99H8zm0-4V13h8v-1.99H8zm0 8h8v-1.99H8V19z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-resume-builder" viewBox="0 0 24 24">
      ...
      <symbol id="icon-plan" viewBox="0 0 24 24">
        <path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2zM9 14H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2zm-8 4H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-radar" viewBox="0 0 24 24">
        <path d="M19.07 4.93l-1.41 1.41A7.957 7.957 0 0112 4C7.58 4 4 7.58 4 12s3.58 8 8 8 8-3.58 8-8c0-2.21-.89-4.22-2.34-5.66l1.41-1.41A9.936 9.936 0 0022 12c0 5.52-4.48 10-10 10S2 17.52 2 12 6.48 2 12 2c2.76 0 5.26 1.12 7.07 2.93zM12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 2c2.21 0 4 1.79 4 4s-1.79 4-4 4-4-1.79-4-4 1.79-4 4-4z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-rocket" viewBox="0 0 24 24">
        <path d="M12 2.5s-4.5 4.5-4.5 10c0 2.5 1 4.5 2.5 6l1.5 1.5 1.5-1.5c1.5-1.5 2.5-3.5 2.5-6C15.5 7 12 2.5 12 2.5zm0 13.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM5.5 16c-1 0-2 1-2 2s1 2 2 2 2-1 2-2-1-2-2-2zm13 0c-1 0-2 1-2 2s1 2 2 2 2-1 2-2-1-2-2-2z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-pen" viewBox="0 0 24 24">
        <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a1.003 1.003 0 000-1.41l-2.34-2.34a1.003 1.003 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-flag" viewBox="0 0 24 24">
        <path d="M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6h-5.6z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-compass" viewBox="0 0 24 24">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm3.5 13.5l-5-2.5L8 18l6-8 2.5 5-1 2.5z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-key" viewBox="0 0 24 24">
        <path d="M12.65 10A5.99 5.99 0 007 6c-3.31 0-6 2.69-6 6s2.69 6 6 6a5.99 5.99 0 005.65-4H17v4h4v-4h2v-4H12.65zM7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-grow" viewBox="0 0 24 24">
        <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6h-6z" fill="currentColor"/>
      </symbol>
      <symbol id="icon-breakthrough" viewBox="0 0 24 24">
        <path d="M7 2v11h3v9l7-12h-4l4-8H7z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-check-badge" viewBox="0 0 24 24">
        <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z" fill="currentColor"/>
      </symbol>
      ...
      <symbol id="icon-slider" viewBox="0 0 24 24">
      ...
      <symbol id="icon-list-doc" viewBox="0 0 24 24">
        <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" fill="currentColor"/>
      </symbol>
